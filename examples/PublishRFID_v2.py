...
#timestamp = 0
SCUTTLE_IDs = [0, 248534172589, 623731415800, 919785904743]
...
while True:
    ...
    #Save previously reaqd ID into variable
    previous_id = id
    ...
    #If Previous Tag does not equal recently Read Tag, then Update Status to Cayenne
    n=0
    if id != previous_id:
        for x in SCUTTLE_STATUS:
